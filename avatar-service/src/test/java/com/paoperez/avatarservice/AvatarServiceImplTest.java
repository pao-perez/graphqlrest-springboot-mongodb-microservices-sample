...
class AvatarServiceImplTest {
    ...
    void getAvatar_whenNonexistingId_shouldThrowNotFoundException() {
        ...
        Exception actual = assertThrows(AvatarNotFoundException.class, () -> service.getAvatar(nonExistingId));
    ...
    void createAvatar_whenExistingUserName_shouldThrowAlreadyExistsException() {
        ...
        Exception actual = assertThrows(AvatarAlreadyExistsException.class, () -> service.createAvatar(newAvatar));
    ...
    void updateAvatar_whenExistingIdAndNonexistingUserName_shouldNotThrowException() {
        ...
        final Avatar updateAvatar = Avatar.builder().id(existingId).userName(nonExistingUserName).imageId("imageIdA")
                .build();
    ...
    void updateAvatar_whenNonexistingId_shouldThrowNotFoundException() {
        ...
        final Avatar updateAvatar = Avatar.builder().id(nonExistingId).userName(updateUserName).imageId("imageIdA")
                .build();
    ...
    void updateAvatar_whenExistingUserName_shouldThrowAlreadyExistsException() {
        ...
        final Avatar existingAvatar = Avatar.builder().id("B").userName(existingUserName).imageId("imageIdB").build();
        when(repository.findByUserName(existingUserName)).thenReturn(existingAvatar);

        final Avatar updateAvatar = Avatar.builder().id(existingId).userName(existingUserName).imageId("imageIdA")
                .build();
    ...
    void deleteAvatar_whenNonexistingId_shouldThrowNotFoundException() {
        ...
        Exception actual = assertThrows(AvatarNotFoundException.class, () -> service.deleteAvatar(nonExistingId));
