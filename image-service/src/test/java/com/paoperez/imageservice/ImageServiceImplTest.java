...
class ImageServiceImplTest {
  ...
  void createImage_whenExistingUrl_shouldThrowAlreadyExistsException() {
    ...
    final Image newImage =
        Image.builder()
            ...
            .build();
    Exception actual =
        assertThrows(ImageAlreadyExistsException.class, () -> service.createImage(newImage));
  ...
  void updateImage_whenExistingIdAndNonexistingUrl_shouldNotThrowException()
    ...
    final Optional<Image> currentImage =
        Optional.of(
            Image.builder()
                .id(existingId)
                .name(currentName)
                .url("/path/to/old/image")
                .alt(currentAlt)
                .width(currentWidth)
  ...
  void updateImage_whenNonexistingId_shouldThrowNotFoundException() {
    ...
    Exception actual =
        assertThrows(
            ImageNotFoundException.class, () -> service.updateImage(nonExistingId, updateImage));
  ...
  void updateImage_whenExistingUrl_shouldThrowAlreadyExistsException() {
    ...
    Exception actual =
        assertThrows(
            ImageAlreadyExistsException.class, () -> service.updateImage(existingId, updateImage));
  ...
  void deleteImage_whenExistingId_shouldNotThrowException() throws ImageNotFoundException {
    final String existingId = "A";
    final Optional<Image> existingImage =
        Optional.of(
            Image.builder()
                .id(existingId)
                .url("/path/to/image")
