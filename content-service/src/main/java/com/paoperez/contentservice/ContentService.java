...
interface ContentService {
     ...
     * @return Content - The created content from the param with timestamp and
     *         generated ID.
     * @throws IllegalStateException - Thrown when withCreated method in
     *                               Content.Builder is invoked and the DateTime
     *                               instance is null.
     */
     ...
     * @throws ContentNotFoundException - Thrown when the id of the content to be
     *                                  updated was not found.
     * @throws IllegalStateException    - Thrown when withUpdated method in
     *                                  Content.Builder is invoked and the DateTime
     *                                  instance is null.
     */
