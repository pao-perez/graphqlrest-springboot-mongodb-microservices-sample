...
class ContentControllerTest {
    ...
    void getAllContents_shouldReturnOk() throws Exception {
        ...
        this.mockMvc.perform(get("/contents").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
    ...
    void getContent_whenExistingId_shouldReturnOk() throws Exception {
        ...
        this.mockMvc.perform(get("/contents/{id}", existingId).contentType(MediaType.APPLICATION_JSON))
    ...
    void getContent_whenNonexistingId_shouldReturnNotFound() throws Exception {
        ...
        this.mockMvc.perform(get("/contents/{id}", nonExistingId).contentType(MediaType.APPLICATION_JSON))
    ...
    void getContent_whenBlankId_shouldReturnBadRequest() throws Exception {
        ...
        this.mockMvc.perform(get("/contents/{id}", blankId).contentType(MediaType.APPLICATION_JSON))
    ...
    void deleteContent_whenExistingId_shouldReturnNoContent() throws Exception {
        ...
        this.mockMvc.perform(delete("/contents/{id}", existingId).contentType(MediaType.APPLICATION_JSON))
    ...
    void deleteContent_whenBlankId_shouldReturnBadRequest() throws Exception {
        ...
        this.mockMvc.perform(delete("/contents/{id}", blankId).contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isBadRequest()).andExpect(jsonPath("$.status").value(HttpStatus.BAD_REQUEST.name()))
                .andExpect(jsonPath("$.message").value(containsString("must not be blank")));
    ...
    void deleteContent_whenNonexistingId_shouldReturnNotFound() throws Exception {
        ...
        this.mockMvc.perform(delete("/contents/{id}", nonExistingId).contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNotFound()).andExpect(jsonPath("$.status").value(HttpStatus.NOT_FOUND.name()))
                .andExpect(jsonPath("$.message").value(String.format("Content with id %s not found.", nonExistingId)));
